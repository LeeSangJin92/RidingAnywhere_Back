...
public class AuthService {
    ...
    public UserResponseDto sigup(UserRequestDto requestDto){
        ...
        Authority authority = authorityRepository.findByAuthorityName(Auth.ROLE_RA_Member).orElseThrow(()->new NullPointerException("❌ 존재 하지 않는 권한입니다."));
        user.setAuthorityId(authority);
